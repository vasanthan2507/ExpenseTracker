...
|---------------|---------------|------------|-----------------------------|
| Food          | 🍴 fa-utensils | #FF6384    | Groceries, restaurants      |
| Transportation| 🚗 fa-car      | #36A2EB    | Fuel, public transport      |
| Entertainment | 🎬 fa-film     | #FFCE56    | Movies, subscriptions       |
| Healthcare    | ❤️ fa-heartbeat| #4BC0C0    | Medical, insurance          |
| Utilities     | 💡 fa-lightbulb| #9966FF    | Electricity, water, internet|
| Education     | 🎓 fa-graduation-cap | #FF9F40 | Courses, books       |
| Shopping      | 🛒 fa-shopping-cart | #FF6384 | Retail purchases     |
| Other         | ⋯ fa-ellipsis-h | #C9CBCF   | Miscellaneous        |
...
│   │   ├── validators.py       # Aadhar validation
...
│   │   ├── admin.py
│   │   ├── apps.py
│   │   ├── models.py           # Expense, ExpenseCategory models
│   │   ├── forms.py            # Expense forms
│   │   ├── views.py            # Expense CRUD views
│   │   ├── urls.py             # Expense URLs
│   │   ├── serializers.py      # For API (optional)
│   │   ├── migrations/
│   │   └── tests/
│   │
...
│   └── receipts/               # Receipt images (future feature)
│
...
requirements_content = """Django==5.0.0
python-decouple==3.8
Pillow==10.2.0
